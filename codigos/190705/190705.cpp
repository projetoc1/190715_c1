...
int main()
{
    ...
    while(true)
    {
    	...
    	{	
        	...
        	//Rotina de setpoints
        	if (rotina_temp>=10) //10 segundos de intervalo entre setpoints
        	{
        		rotina_temp = 0;
        		rotina = rotina + 1;
        		if (rotina==4)
        	...
        	//(-10,-10),(10,-10),(10,10),(-10,10) repetição
        	if (rotina==0)
        	{
        		setpoint0   = grau_min;
        		setpoint0z  = grau_min;
        	...
        	setpoint = setpoint0*(1-exp(-rotina_temp/1));
        	//EIXO Z
        	if (setpoint_lon!=300)
        	{
        	...
        	setpointz = setpoint0z*(1-exp(-rotina_temp/1));
